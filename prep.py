...
def save_dataset(args):
    ...
    for p_ind, patient in enumerate(patients_list):
        ...
        for pi in range(len(full_pixels)):
            ...
            np.save(os.path.join(args.save_path, f_name), full_pixels[pi])
    print(' ')


def load_scan(path):                                                #dicom读取图片
...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_path', type=str, default='D:/CT_Project/lung_data/L506/')
    parser.add_argument('--save_path', type=str, default='./mayo_L506/npyfiles')
